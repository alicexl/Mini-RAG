...
def main():
    ...
    # 5 段测试文本 —— 语义上有近有远
    texts = [
        "盐湖股份2024年营业收入为150亿元，同比增长12%。",
        "盐湖股份2023年营收约134亿元，钾肥业务是主要收入来源。",
        "今天天气不错，适合出去散步。",
        "碳酸锂价格在2024年持续下跌，从年初的10万元/吨跌至年末的7万元/吨。",
        "盐湖股份的碳酸锂产能位居全国前列，2024年产量达到3.5万吨。",
    ]
    ...
    print("解读:")
    print("=" * 60)
    print("  文本1和文本2: 都是盐湖股份营收，语义接近 → 相似度高")
    print("  文本1和文本3: 一个说营收，一个说天气，语义无关 → 相似度低")
    print("  文本4和文本5: 都涉及碳酸锂，语义有关 → 相似度较高")
    print()
